...
option(PYRO_PLATFORM_TIME "Include time functionalities" ON)
option(PYRO_PLATFORM_WINDOWING "Include windowing systems" ON)
option(PYRO_PLATFORM_GAMEPAD "Include gamepad systems" ON)
...
if (PYRO_PLATFORM_GAMEPAD)
    # ==== Gamepad Backends ====
    set(PYRO_PLATFORM_GAMEPAD_SYSTEM "GLFW" CACHE STRING "Gamepad system")
    set_property(CACHE PYRO_PLATFORM_GAMEPAD_SYSTEM PROPERTY STRINGS "GLFW")

    message(STATUS "Selected gamepad system: ${PYRO_PLATFORM_GAMEPAD}")
    ...
    if (PYRO_PLATFORM_DUMMY_INTERFACE)
        ...
        # Set macros accordingly
        if (PYRO_PLATFORM_GAMEPAD_SYSTEM STREQUAL "GLFW")
            if (PYRO_PLATFORM_WINDOWING_SYSTEM STREQUAL "GLFW")
                add_definitions(-DPYRO_PLATFORM_GAMEPAD_GLFW=1)
                set(PYRO_PLATFORM_GAMEPAD_GLFW 1)
                set(PYRO_PLATFORM_GAMEPAD_DIRNAME "Glfw")
            else ()
                message(FATAL_ERROR "Using the GLFW gamepad backend requires the GLFW windowing system.")
            endif ()
        else ()
            message(FATAL_ERROR "Unsupported windowing system: ${PYRO_WINDOWING_SYSTEM}")
        endif ()
